                                ...
                                dbc.Row([
                                    ...
                                    dbc.Col([
                                        ...
                                        dbc.Checklist(
                                            ...
                                            input_checked_style={'backgroundColor': 'blue', 'borderColo': 'orange'},
                                        ),
                                        dbc.Button('Remover', color='warning', id='remove-category-receita', style={'margin-top':'20px'}),
                                    ], style={'margin-left':'10px', 'width':6})
                                ])
            ...
            dbc.Modal([
                ...
                dbc.ModalBody([
                    dbc.Row([
                        dbc.Col([
                            dbc.Label('Descrição: '),
                            dbc.Input(placeholder="Ex.: gasolina, inglês, escola...", id="txt-despesa"),
                        ], width=6),
                        dbc.Col([
                            dbc.Label('Valor: '),
